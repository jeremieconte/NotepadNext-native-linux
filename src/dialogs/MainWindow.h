...
private slots:
    ...
    // Re-applies the theme when the desktop portal reports a settings change
    // (e.g. the GNOME 50 "Dark Style" toggle), while following the system.
    void desktopPortalSettingChanged(const QString &nspace, const QString &key);
